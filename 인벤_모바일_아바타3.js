...
$(document).ready(function(){
    ...
    let costom_item_img_array =['./img/아바타자랑/costom_item/ab_4/0.jpg','./img/아바타자랑/costom_item/ab_4/1.jpg','./img/아바타자랑/costom_item/ab_4/2.jpg','./img/아바타자랑/costom_item/ab_4/3.jpg','./img/아바타자랑/costom_item/ab_4/4.jpg','./img/아바타자랑/costom_item/ab_4/5.jpg','./img/아바타자랑/costom_item/ab_4/6.jpg','./img/아바타자랑/costom_item/ab_4/7.jpg']
    ...
    let cos_hd_txt1_array=['예쁜 마네킹','영꾸','예쁜','ㅂㅋ','요즈 루핏 [사진많음]','베른 입성..!','신상','로아캐릭으로 미드저...']
    for(let i=0; i<cos_hd_txt1_array.length; i++){
        $('.cos_hd_txt1').eq(i).text(cos_hd_txt1_array[i])
    }


    let user_name_array=['서론','미네','슈히또','즐생','닐레야','이바나','Iridescence','아르모']
