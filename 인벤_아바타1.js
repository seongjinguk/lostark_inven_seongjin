...
$(document).ready(function(){
 ...
 $(document).ready(function(){
    ...
    let costom_item_img_array =['./img/아바타자랑/costom_item/ab_2/8.jpg','./img/아바타자랑/costom_item/ab_2/9.jpg','./img/아바타자랑/costom_item/ab_2/10.jpg','./img/아바타자랑/costom_item/ab_2/11.jpg','./img/아바타자랑/costom_item/ab_2/12.jpg','./img/아바타자랑/costom_item/ab_2/13.jpg','./img/아바타자랑/costom_item/ab_2/14.jpg','./img/아바타자랑/costom_item/ab_2/15.jpg']
    ...
    let cos_hd_txt1_array=['힙찔이 데런','데런','커마권','고앵','포니테일 최고다','벽안 데런','청청','데모닉 영원 전압 염색']
    for(let i=0; i<cos_hd_txt1_array.length; i++){
        $('.cos_hd_txt1').eq(i).text(cos_hd_txt1_array[i])
    }


    let user_name_array=['도잇츄','나랑이','오늘부터우린','느에에에','Pseud0nym','터치미','따뜻한비빔면','코코코레드코']
